...
| --- | --- | --- |
| Committed source, architecture and automated conformance | `0.8.1` [local requalification](results-cancellation-2026-09-08.md) and [distribution CI on `43b6a1f`](results-distribution-ci-2026-09-08.md); prior version results remain separate | Requalify changed inputs and the final release revision; separate macOS/Ubuntu manual workflow remains on the earlier revision; do not erase intermittent failures |
| Offline prebuilt installation | [Unsigned `0.8.1` candidate](results-distribution-ci-2026-09-08.md) passed exact-version local npm installation, installed client tests and artifact upload | Record hashes and test the actual final signed packages, not a previous local build |
...
| New-process and HTTP delivery | Automated conformance plus [genuine modes and revocation](results-consent-2026-09-08.md), [pending cancellation and process-grant restart](results-cancellation-2026-09-08.md), and [actual in-flight cancellation](results-permission-recovery-2026-09-08.md) | Resolve [intermittent packaged process uncertainty](results-distribution-ci-2026-09-08.md); remaining recovery/late-human decisions, changed-recipient native refusal, process trees and full native dialog readability in the [runbook](process.md) |
...
| Performance and reliability | [Repeated installed trials, bounded CPU/RSS/load/capacity/shutdown observations](results-reliability-2026-09-08.md) plus browser-start trials | Resolve the retained findings; installed standalone-daemon/browser-tree idle/peak resources and a long soak remain unqualified; test-process counters are not a production guarantee |
