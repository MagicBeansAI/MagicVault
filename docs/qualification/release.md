...
| Performance and reliability | [Corrected `0.8.2` installed trials, bounded CPU/RSS/load/capacity/shutdown observations](results-completion-order-2026-09-08.md) plus browser-start trials; [original reliability findings](results-reliability-2026-09-08.md) retained | Resolve the retained findings; installed standalone-daemon/browser-tree idle/peak resources and a long soak remain unqualified; test-process counters are not a production guarantee |
