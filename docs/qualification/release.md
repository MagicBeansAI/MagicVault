...
| --- | --- | --- |
| Committed source, architecture and automated conformance | [Standalone `0.8.2` completion-order correction and deterministic regressions](results-completion-order-2026-09-08.md); prior version CI remains separately identified | Requalify changed inputs and the final release revision; do not erase intermittent failures or attribute older CI to new binaries |
