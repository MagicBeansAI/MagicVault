...
The later focused CI on `58592ee` **failed in trial 42**: the owned child was
already `SIGKILL`-terminated before cleanup; the sender/OS reason remains unknown.
