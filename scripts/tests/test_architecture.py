...
class Architecture(unittest.TestCase):
    ...
    def test_distribution_launchers_scripts_and_workflow_are_covered(self):
        ...
        before = GATE.snapshot(self.root)
        for name in ["npm/launcher.cjs", "scripts/package-npm.mjs", "scripts/release-npm.mjs", ".gitattributes", ".github/workflows/npm-release.yml", ".github/workflows/ci.yml", ".github/workflows/desktop-platforms.yml", "scripts/sign-release.sh", "scripts/process-investigation.mjs", ".github/workflows/distribution.yml", ".github/workflows/qualification.yml", ".github/workflows/process-investigation.yml"]:
